...
**ecostructure** is an R package for clustering and visualizing structure in ecological assemblages using Mixed Membership or Grade of Membership (GoM) models (see [reference](https://www.stat.washington.edu/sites/default/files/files/reports/2006/tr492.pdf): -@erosheva2006latent). The package can incorporate ecological census data of many kinds - your data may reflect anything from species abundances in local communities (e.g., classical community ecology; -@white2019regional) to the presence and absence of species across continents (e.g., macroecology and biogeography; -@white2019regional,@white2021dispersal,@li2021grade,@rana2022key).

To further parse biological structure in the data, **ecostructure** allows phylogenetic, geographic, and morphological data to be incorporated in the clustering framework, producing clusters that represent variation among these axes of diversity when taking the similarity of species into account. In this framework, we call the clusters *motifs*.
